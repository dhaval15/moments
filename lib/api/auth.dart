...
class PhoneAuthAPI {
  ...
  static Future<FirebaseUser> get currentUser => FirebaseAuth.instance.currentUser();
  static Future<String> get currentUID async => (await FirebaseAuth.instance.currentUser()).uid;
